  ...
  return (
    <SafeAreaView className="h-full w-full flex">
      ...
      <TouchableOpacity
        ...
        className="h-10 w-10 rounded-full bg-blue-900 ml-3 mt-4  flex justify-center items-center"
      >
        <Icon name="angle-left" color="#fff" size={25} />
      </TouchableOpacity>
      <View className="flex-1 pt-12 items-center space-y-7">
        ...
        <View className="flex space-y-8">
          <View className="block">
            <Text className=" font-bold mb-3 text-base">Email</Text>
            <TextInput
              onChangeText={(text) => {
                setEmail(text);
              }}
          ...
          <View className="block">
            <Text className=" font-bold mb-3 text-base">Password</Text>
