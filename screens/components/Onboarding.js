            ...
            <SafeAreaView className="flex-1">
                <View className="mt-20 flex items-center space-y-7">
                    ...
                    <TouchableOpacity
                        ...
                        className="w-52 border-2 border-blue-400 rounded-3xl h-14 flex justify-center items-center bg-blue-800"
                    >
                ...
                {/* {isLoading && <ActivityIndicator color={`#fff`} size={25} />} */}
                <View className="flex flex-row justify-center items-end flex-1">
                    <Image
                        source={require("../../assets/Fernandez_enzo_profile_2024-25_avatar-removebg.png")}
                        resizeMode="contain"
                        className="h-80 -z-20 -right-24"
                    />
                    <Image
                        source={require("../../assets/Fernandez_enzo_profile_2024-25_avatar-removebg.png")}
                        resizeMode="contain"
                        className="h-80 -z-10 absolute"
                    />
                    <Image
                        source={require("../../assets/Fernandez_enzo_profile_2024-25_avatar-removebg.png")}
                        resizeMode="contain"
                        className="h-80 -z-20 -left-24"
                    />
                </View>
            </SafeAreaView>
        </View>
